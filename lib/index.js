...
function runServe(project) {
    ...
    new process_list_1.ProcessList(deps.slice(0, -1), deps[deps.length - 1], dir, commander_1.default.detached, false, [], commander_1.default.verbose);
}
function runBuild(project) {
    console.log(commander_1.default.name());
    console.log("Building project " + project + "...");
    var _a = getEnvironment(commander_1.default, project), deps = _a.deps, dir = _a.dir;
    new process_list_1.ProcessList(deps.slice(0, -1), deps[deps.length - 1], dir, commander_1.default.detached, true, commander_1.default.prod ? commander_1.default.prod.split(',') : [], commander_1.default.verbose);
}
